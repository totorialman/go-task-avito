...
const (
	...
	PVZService_GetAllPVZ_FullMethodName  = "/pvz.v1.PVZService/GetAllPVZ"
)
...
type PVZServiceClient interface {
	...
	GetAllPVZ(ctx context.Context, in *GetAllPVZRequest, opts ...grpc.CallOption) (*GetAllPVZResponse, error)
}
...
func (c *pVZServiceClient) GetAllPVZ(ctx context.Context, in *GetAllPVZRequest, opts ...grpc.CallOption) (*GetAllPVZResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAllPVZResponse)
	err := c.cc.Invoke(ctx, PVZService_GetAllPVZ_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PVZServiceServer interface {
	...
	// Получение всех ПВЗ (без авторизации, доп. задание)
	GetAllPVZ(context.Context, *GetAllPVZRequest) (*GetAllPVZResponse, error)
...
func (UnimplementedPVZServiceServer) GetAllPVZ(context.Context, *GetAllPVZRequest) (*GetAllPVZResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllPVZ not implemented")
}
...
func _PVZService_GetAllPVZ_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAllPVZRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PVZServiceServer).GetAllPVZ(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PVZService_GetAllPVZ_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PVZServiceServer).GetAllPVZ(ctx, req.(*GetAllPVZRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PVZService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAllPVZ",
			Handler:    _PVZService_GetAllPVZ_Handler,
		},
	},
